...
public class PanelAsigurare extends JPanel {

	/**
	 * Create the panel.
	 */
	private PanelAsigurare_afisare panelAfis;
	private Blank blk;
	private PanelAsigurare_statistici panelStat;
	
	
	public PanelAsigurare() {
		setBounds(0, 0, 915, 655);
		setLayout(null);
		panelAfis=new PanelAsigurare_afisare();
		blk=new Blank();
		panelStat=new PanelAsigurare_statistici();
