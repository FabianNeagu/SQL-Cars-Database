...
public class Meniu2 {
	...
	private PanelAsigurare panelAsig;
	private PanelInch panelInch;
	private PanelAutoturism panelAuto;
	private PanelCategorie panelCateg;
	private PanelClienti panelClient;
	private PanelFactura panelFactura;
	private PanelLocatie panelLocatie;
	
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Meniu2 window = new Meniu2();
	...
	private void initialize() {
		...
		panelAsig=new PanelAsigurare();
		panelInch=new PanelInch();
		panelAuto=new PanelAutoturism();
		panelCateg=new PanelCategorie();
		panelClient=new PanelClienti();
		panelFactura=new PanelFactura();
		panelLocatie=new PanelLocatie();
		...
		panelMain.setBounds(290, 13, 915, 655);
		panelMain.setLayout(null);
		panelMain.add(panelHome);
		panelMain.add(panelAuto);
		panelMain.add(panelCateg);
		panelMain.add(panelClient);
		panelMain.add(panelFactura);
		panelMain.add(panelLocatie);
		panelMain.add(panelAsig); 
		panelMain.add(panelInch);
		menuClicked(panelHome);
	...
	public void menuClicked(JPanel panel)
	{
		...
		panelCateg.setVisible(false);
		panelClient.setVisible(false);
		panelFactura.setVisible(false);
		panelLocatie.setVisible(false);
		panelHome.setVisible(false);
		panelInch.setVisible(false);
