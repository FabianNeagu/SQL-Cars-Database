...
public class PanelFactura extends JPanel {
	private PanelFactura_afisare panelAfis;
	private Blank blk;
	private PanelFactura_statistici panelStat;
	
	
	public PanelFactura() {
		setBounds(0, 0, 915, 655);
		setLayout(null);
		panelAfis=new PanelFactura_afisare();
		blk=new Blank();
		panelStat=new PanelFactura_statistici();
